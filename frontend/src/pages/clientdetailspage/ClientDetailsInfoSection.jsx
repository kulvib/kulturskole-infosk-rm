...
// FIX: formatUptime håndterer nu altid rent sekund-tal (fra lokal ticker)
// samt de gamle formater (d-HH:MM:SS, HH:MM:SS osv.)
function formatUptime(uptimeStr) {
  if (uptimeStr === null || uptimeStr === undefined || uptimeStr === "") return "ukendt";
  ...
  if (str.includes("-") && str.includes(":")) {
    ...
    // Rent sekund-tal (fra lokal ticker eller backend)
