# ClientFlow Render install site v6.10
...
clientflow_clean_ubuntu_installer_v6.10.zip
clientflow_clean_ubuntu_installer_v5.zip
clientflow_version.json
autoinstall.yaml
```

`clientflow_clean_ubuntu_installer_v5.zip` er alias til nyeste v6.10, så ældre launchere/self-update flows ikke knækker.
...
Selfupdate-status/progression rapporteres nu til backend/frontend.
